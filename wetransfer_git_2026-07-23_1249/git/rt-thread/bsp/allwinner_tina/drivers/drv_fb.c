...
#define  HT  656	  	//Horizontal total period = (HT + 1) pixels					526
#define  HPS 60       	//Horizontal Sync Pulse Start Position = (HPS + 1) pixels	 24
#define  LPS 30        	//Horizontal Display Period Start Position = LPS pixels		  1
#define  HPW 10       	//Horizontal Sync Pulse Width = (HPW + 1) pixels			  4

#define  VT  950    	//Vertical Total = (VT + 1) lines				 		911
#define  VPS 35       	//Vertical Sync Pulse Start Position = VPS lines		  4		  
#define  FPS 18       	//Vertical Display Period Start Position = FPS lines	  0		  
#define  VPW 1        	//Vertical Sync Pulse Width = (VPW + 1) lines			  1
*/
