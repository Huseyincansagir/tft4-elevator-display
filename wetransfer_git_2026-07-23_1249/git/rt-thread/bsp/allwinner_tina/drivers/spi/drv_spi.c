...
int rt_hw_spi_init(void)
{
    ...
    /* register spi bus */
    {
        ...
        gpio_set_func(GPIO_PORT_E, GPIO_PIN_8, IO_FUN_3);
        gpio_set_func(GPIO_PORT_E, GPIO_PIN_9, IO_FUN_3);
        gpio_set_func(GPIO_PORT_E, GPIO_PIN_10, IO_FUN_3);
    ...
    /* attach cs */
    {
        ...
        spi_cs.cs = SPI_TCTRL_SS_SEL_SS0;
        gpio_set_func(GPIO_PORT_E, GPIO_PIN_7,  IO_FUN_3);
